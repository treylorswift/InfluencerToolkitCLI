...
async function main() {
    ...
    if (process.argv[2] === '-rebuildFollowers') {
        ...
        let followerCache = new TwitterFollowerDB_1.TwitterFollowerCacheSQL();
    ...
    if (campaign) {
        ...
        if (status.status === TwitterFollowerDB_1.FollowerCacheStatusEnum.None) {
        ...
        else if (status.status === TwitterFollowerDB_1.FollowerCacheStatusEnum.Incomplete) {
